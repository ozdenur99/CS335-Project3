...
public class LoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        // X-Forwarded-For is trusted here intentionally for Locust load testing (IP simulation).
        // In production, X-Forwarded-For should only be trusted from known proxy IPs to prevent IP spoofing.
        ...
        // 1. Try to get the fake IP generated by Locust

        // CHANGE THIS CODE BEFORE USING THE CODE
        // String ip = request.getHeader("X-Forwarded-For");

        // // 2. If the header is missing (e.g., normal Postman request), fall back to
        // standard IP
        // if (ip == null || ip.isBlank()) {
        // ip = request.getRemoteAddr();
        // } else {
        // // If it passed through multiple proxies, take the first IP in the list
        // ip = ip.split(",")[0].trim();
        // }
