    ...
    */
    ...
    public void evaluateAndAdjustLimits() {
        ...
        for (String clientId : activeClients) {
            ...
            long p95Latency = percentiles.getOrDefault("p50", 0L);
            ...
            if (p95Latency > latencyThresholdMs) {
                ...
                newLimit = Math.min(maxAllowedLimit, currentLimit + additiveIncrease);
            }
