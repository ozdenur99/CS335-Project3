...
# The exact whitelist from your application.properties
VALID_KEYS = [
...
class ApiGatewayUser(HttpUser):
    ...
    def create_note(self):
        payload = '{"title": "Load Test", "content": "Hello from Locust"}'
        with self.client.post(f"/api/{self.guid}/notes", data=payload, headers=self._get_headers(), catch_response=True) as response:
